@component('admin.layouts.content' , ['title' => 'پنل مديريت'])
    ...
    <li class="breadcrumb-item"><a href="">پنل مدیریت</a></li>
        <li class="breadcrumb-item " ><a href="{{ route('admin.users.index') }}">ليست كاربران</a></li>
        ...
        <div class="card">
              ...
              <form class="form-horizontal" method="post" action="{{ route('admin.users.update' , ['user' => $user->id]) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="inputname11" placeholder="ایمیل را وارد کنید" value="{{ $user->name }}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password"  name="password_confirmation" class="form-control" id="inputPassword3" placeholder="دوباره پسورد را وارد کنید">
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info">ویرایش کابر</button>
