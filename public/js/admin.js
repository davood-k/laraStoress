...
(function ($) {
  ...
  $('.sidebar-mini .main-header .nav-item').click(function () {
    var sidebar_mini = $('.sidebar-mini');
    var class_name = sidebar_mini.attr('class');
  ...
  var _sidebar_class = checkCookie('sidebar_class') ? getCookie('sidebar_class') : 'sidebar-open';

  var _main_header_color = checkCookie('main_header_color') ? getCookie('main_header_color') : 'navbar-dark bg-success';

  var _main_header_border = checkCookie('main_header_border') ? getCookie('main_header_border') : 'border-bottom';

  var _main_sidebar_color = checkCookie('main_sidebar_color') ? getCookie('main_sidebar_color') : 'sidebar-dark-info';

  var _logo_color = checkCookie('logo_color') ? getCookie('logo_color') : 'bg-success';
